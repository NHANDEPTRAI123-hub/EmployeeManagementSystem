...
namespace EmployeeManagementSystem
{
    ...
    public abstract class Users
    {
        ...
        public Users(int id, string username, string password, DateTime dateRegister)
        {
            ID = id;
            Username = username;
            Password = password;
        ...
        {
            return $"User: {Username}, Registered on: {DateRegister.ToShortDateString()}";
        }
    ...
    public class Employee : Users
    {
        ...
        public Employee(int id, string username, string password, DateTime dateRegister)
